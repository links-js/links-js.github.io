var getIconForOs,getOs,getTagClass,injectCss,isYaml,isYamlOrJson,splitThenAdd,stripQuotes;injectCss=function(n){var t,e;return e=void 0,"string"==typeof n&&(n=n.trim(),e=0===n.indexOf("/")||0===n.indexOf("http:")||0===n.indexOf("https:")?"link":"style",t=document.createElement(e),t.type="text/css","link"===e?(t.rel="stylesheet",t.href=n):t.innerHTML=n,document.head.appendChild(t),t)},getOs=function(){var n;return n=navigator.platform.toUpperCase(),n.indexOf("MAC")>-1?"mac":n.indexOf("WIN")>-1?"windows":n.indexOf("LINUX")>-1?"linux":"windows"},isYamlOrJson=function(n){return/\.(ya?ml|json)$/.test(n)},isYaml=function(n){return/\.(ya?ml)$/.test(n)},stripQuotes=function(n){return n.replace(/^"(.*)"$/,"$1")},getTagClass=function(n){var t;return t=1,n>10&&(t=10),n>25&&(t=25),n>50&&(t=50),n>100&&(t=100),"tag-"+t},splitThenAdd=function(n,t){return n.split("\n").concat(t).join("\n")},getIconForOs=function(n){return n.includes("mac")?"fa-apple":n.includes("windows")?"fa-windows":n.includes("linux")?"fa-linux":""};
